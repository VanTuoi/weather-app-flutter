...
> **Note**: This repository is a clone of the [Flutter Weather App](https://github.com/AbdQader/flutter_weather_app) by [AbdQader](https://github.com/AbdQader). The purpose of this repository is for **personal learning** and **educational purposes only**. All credits and rights are reserved to the original author. Any redistribution or commercial use should be done with proper permissions from the original author.
